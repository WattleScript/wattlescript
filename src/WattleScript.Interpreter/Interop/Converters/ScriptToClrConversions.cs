...
namespace WattleScript.Interpreter.Interop.Converters
{
    internal static class ScriptToClrConversions
    {
        ...
        {
            var converter =
                Script.GlobalOptions.CustomConverters.GetScriptToClrCustomConversion(value.Type, typeof(System.Object));
            if (converter != null)
            {
        ...
        internal static T DynValueToObject<T>(DynValue value, T defaultValue, bool isOptional)
        {
            ...
            if (typeof(T) == typeof(DynValue))
                return (T)(object)value;

            if (typeof(T) == typeof(object))
                return (T)DynValueToObject(value);

            StringConversions.StringSubtype stringSubType = StringConversions.GetStringSubtype(typeof(T));
            string str = null;
            ...
            switch (value.Type)
            {
                ...
                case DataType.Number:
                    if (typeof(T).IsEnum)
                    {
                        ...
                        return (T)NumericConversions.DoubleToType(underType, value.Number);
                    }

                    if (NumericConversions.NumericTypes.Contains(typeof(T)))
                    {
                        object d = NumericConversions.DoubleToType(typeof(T), value.Number);
                ...
                case DataType.String:
                    ...
                    break;
                case DataType.Function:
                    if (typeof(T) == typeof(Closure)) return (T)(object)value.Function;
                    if (typeof(T) == typeof(ScriptFunctionDelegate)) return (T)(object)value.Function.GetDelegate();
                    break;
                case DataType.ClrFunction:
                    if (typeof(T) == typeof(CallbackFunction)) return (T)(object)value.Callback;
                    if (typeof(T) == typeof(Func<ScriptExecutionContext, CallbackArguments, DynValue>))
                        return (T)(object)value.Callback.ClrCallback;
                    break;
                case DataType.UserData:
                    if (value.UserData.Object != null)
                    {
                        ...
                        if (udDesc.IsTypeCompatible(typeof(T), udObj))
                            return (T)(object)udObj;
                    ...
                    break;
                case DataType.Table:
                    if (typeof(T) == typeof(Table) || typeof(T).IsAssignableFrom(typeof(Table)))
                        return (T)(object)value.Table;
                    object o = TableConversions.ConvertTableToType(value.Table, typeof(T));
                    if (o != null)
                        return (T)(object)o;
                    break;
                case DataType.Range:
                    if (typeof(T) == typeof(Range) || typeof(T).IsAssignableFrom(typeof(Range)))
                        return (T)(object)value.Range;
                    break;
                case DataType.Tuple:
                    break;
            }
            ...
            if (stringSubType != StringConversions.StringSubtype.None && str != null)
                return (T)StringConversions.ConvertString(stringSubType, str, typeof(T), value.Type);

            throw ScriptRuntimeException.ConvertObjectFailed(value.Type, typeof(T));
        }
