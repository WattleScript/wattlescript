...
namespace WattleScript.Interpreter
{
	...
	public sealed class WattleScriptUserDataAttribute : Attribute
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="WattleScriptUserDataAttribute"/> class.
		/// </summary>
		public WattleScriptUserDataAttribute()
		{
