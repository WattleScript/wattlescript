...
namespace WattleScript.Interpreter.Interop.BasicDescriptors
{
	/// <summary>
	...
	public abstract class DispatchingUserDataDescriptor : IUserDataDescriptor, IOptimizableDescriptor
	{
		...
		/// 
		/// If a method exists marked with <see cref="WattleScriptUserDataMetamethodAttribute" /> for the specific
