    ...
    public partial class HardwireSourceGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            try
            {
                ...
                {
                    writer.Append("WattleScript.Interpreter.UserData.RegisterType(new ").Append(str).AppendLine("());");
                }
        ...
        static bool IsUserData(ITypeSymbol type)
        {
            return type.GetAttributes()
                .Any(a => a.AttributeClass?.ToString() == "WattleScript.Interpreter.WattleScriptUserDataAttribute");
        }
